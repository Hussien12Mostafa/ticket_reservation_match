...
class UserMatchListTileWidget extends StatefulWidget {
  final Match match;
  UserMatchListTileWidget({this.match});

  @override
  _UserMatchListTileWidgetState createState() =>
      _UserMatchListTileWidgetState();
}

class _UserMatchListTileWidgetState extends State<UserMatchListTileWidget> {
                ...
                child: TextButton(
                    ...
                    onPressed: () {
                      AwesomeDialog(
                          ...
                          btnOkOnPress: DateFormat("yyyy-MM-dd")
                                  .parse(widget.match.date.toString())
                                  .isAfter(DateTime.now())
                              ? () {
                                  matchProvider.setMatchToBook(
                                      widget.match, authenticationProvider.id);
                                  _navigationService
                                      .navigateTo(routes.bookMatch);
                                }
                              : null,
                          btnCancelOnPress: () {},
                          btnOkText: 'Book',

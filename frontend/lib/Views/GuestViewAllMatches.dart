...
import 'package:worldcup/Widgets/GuestMatchListTileWidget.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';
import '../Models/Match.dart';

class GuestAllMatchesView extends StatefulWidget {
  @override
  _GuestAllMatchesViewState createState() => _GuestAllMatchesViewState();
}

class _GuestAllMatchesViewState extends State<GuestAllMatchesView> {
              ...
              child: ListView(
                ...
                children: [
                  ...
                  matchesProviderForLists.status == Status.loading
                      ...
                      : Container(
                          margin: EdgeInsets.fromLTRB(deviceSize.width * 0.2, 0,
                                  ...
                                  ? Scrollbar(
                                      ...
                                      child: ListView.builder(
                                        ...
                                        itemBuilder: (context, index) {
                                          return GuestMatchListTileWidget(
                                            match: matches[index],
                                          );
                                        },
                                      ),
